-- PostgreSQL Schema for Interactive RAG Agent
...
-- Drop existing objects for clean reset
...
-- Function: Hybrid search combining vector and text similarity
...
-- Function: Get all chunks for a document
