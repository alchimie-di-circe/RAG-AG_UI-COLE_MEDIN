"""Dependencies for the Interactive RAG Agent."""
...
class AgentDependencies:
    ...
    This class manages database connections and OpenAI client
    for embeddings. It's used by search tools to access the
    knowledge base.
    """
